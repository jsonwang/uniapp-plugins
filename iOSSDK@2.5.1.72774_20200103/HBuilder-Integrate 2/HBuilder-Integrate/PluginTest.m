...
//        UINavigationController *nav = [[UIApplication sharedApplication] visibleNavigationController];
        ...
        [rootViewController pushViewController:[LBDeviceListViewController new] animated:YES];
//        [rootViewController presentViewController:[LBDeviceListViewController new] animated:YES completion:nil];
        // 通知JS层Native层运行结果
